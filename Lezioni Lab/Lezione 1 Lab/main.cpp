...
int main(int argc, char *argv[])
{
    ...
    // memoria stack -> viene uccisa prima anna e poi mario -> l'ultima ad essere modificata � la prima ad essere eliminata
    anna.stampa();
    // reminder : c'� una copia non degli elementi ma dell'indirizzo,
